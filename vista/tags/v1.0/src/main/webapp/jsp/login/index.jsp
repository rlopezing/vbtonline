...
<head>
    ...
    <script src="../vbtonline/resources/jquery/jquery-1.7.2.js?_expirecache_=1"></script>
    <script src="../vbtonline/resources/jquery/jquery-ui.1.8.js?_expirecache_=1"></script>
