    ...
    <table SUMMARY='tabla'cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <tr>
            ...
            <td width="70%">
                ...
                <input id="FC_ReceiverInformation" type="text" title="Amount & Instructions: Receiver Information" class="invisible_print inputFormulario_TOB_FC" style="width: 300px" maxlength="60" size="55"/>
            </td>
    ...
    <table SUMMARY='tabla'cellpadding="0" cellspacing="0" width="100%" border="0">
        <tr>
            ...
            <td width="70%">
                ...
                <input id="FC_Motivo" type="text" title="Motivo de la Transferencia: Motivo" class="invisible_print obligatorioTOB_FC inputFormulario_TOB_FC" style="width: 300px" maxlength="60" size="55"/>
            </td>
