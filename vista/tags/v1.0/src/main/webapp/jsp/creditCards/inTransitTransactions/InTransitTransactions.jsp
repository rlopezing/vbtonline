        ...
        <TABLE border="0" cellspacing="0" cellpadding="0" width="95%" align="center">
            ...
            <tr height="30">
                <td align="center" class="A7NVerde">
                    <%--<A class="" HREF="" title="Click para continuar" target="" id="TDC_continuar">Click para continuar >></A>--%>
...
<fieldset class="div_consulta">
    <table SUMMARY='tabla' cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td class="datos">
                <select  id="numero_cuenta_TDC_ITT" title="Numero de Tarjeta" class="requerido_TDC_ITT invisible_print" onchange="cargarSaldosITT(this.value)" >

                </select>
                <span id="numero_cuenta_TDC_ITT_select" class="visible_print"></span>
            </td>
            <td  class="botones_formulario" width="60%">
