...
//        $("#div_buscarUsuarioContrato").fadeIn("fast");
...
//        $("#div_tabla_consultaContratos").fadeOut("fast");
...
//        $("#div_tabla_consultaContratos").fadeOut("fast");
    ...
    $("#btn_add_usr").click(function(){
      var mensaje="";
        ...
        if(mensaje!=""){
            ...
            var valor= $("#AU_contratoNombre").val()+"|"+$("#AU_contratoCirif").val()+"-"+$("#AU_contratoCiRifvalor").val()+"|"+$("#AU_contratoTelefono").val()+"|"+$("#AU_contratoCelular").val()+"|"+$("#AU_contratoDireccion").val()+"|"+$("#AU_contratoEmail").val()+"|"+$("#AU_contratoGrupo").val();
    ...
    $("#btn_add_usr_edit").click(function(){
        ...
        if(mensaje!=""){
            ...
            var valor= $("#EU_contratoNombre").val()+"|"+$("#EU_contratoCirif").val()+"-"+$("#EU_contratoCiRifvalor").val()+"|"+$("#EU_contratoTelefono").val()+"|"+$("#EU_contratoCelular").val()+"|"+$("#EU_contratoDireccion").val()+"|"+$("#EU_contratoEmail").val()+"|"+$("#EU_contratoGrupo").val();
...
//        $("#div_buscarCarteraContrato").fadeIn("fast");
            ...
            $.each($("#tabla_AC_consultarUsuarioContrato .nuevoUsuario"),function(pos,item){
                if($("#guardar_"+this.id.split("_")[1]).is(':checked')){
                    ...
                    if (existeUsuario=="OK"){
                        ...
                        usuario.telefono_celular=$("#telefonoCelular_"+this.id.split("_")[1]).val();
...
//         alert(JSON.stringify(lista_carteras));
    ...
    $("#EC_salvar").click(function(){
        ...
        $("#tabla_EC_consultarUsuarioContrato .ObligatorioECTelefono").each(function(){
            if($("#guardar_"+this.id.split("_")[1]).is(':checked')){
        ...
        $("#tabla_EC_consultarUsuarioContrato .ObligatorioECEmail").each(function(){
            if($("#guardar_"+this.id.split("_")[1]).is(':checked')){
                if(($("#"+this.id).val()==" ") || $("#"+this.id).val()=="-2"){
                    mensaje=mensaje+"Campo requerido - "+ this.title+"<br>";
                    $("#"+this.id).addClass("error_campo");
        ...
        if(mensaje!=""){
            ...
            $.each($("#tabla_EC_consultarUsuarioContrato .nuevoUsuario"),function(pos,item){
                if($("#"+item.id).is(':checked')){
                    ...
                    if (existeUsuario=="OK"){
                        ...
                        usuario.tipo=$("#tipoCliente_"+this.id.split("_")[1]).val();
                        usuario.telefono_celular=$("#telefonoCelularV_"+this.id.split("_")[1]).val();
            ...
            $.each($("#tabla_EC_consultarUsuarioContrato .loginUsuario"),function(pos,item){
                    ...
                    usuarioViejo.telefono_celular=$("#telefonoCelularV_"+this.id.split("_")[1]).val();
...
function fnClickAddRowUsuario(valor) {
    ...
    $('#tabla_EC_consultarUsuarioContrato').dataTable().fnAddData( [
        ...
        '<input type="TEXT" id="loginUsuario_'+giCount+'"title="Usuario" class="loginUsuario obligatorio_EUBO" maxlength="16" style="width: 220px" >',
       // '<span id="email_'+giCount+'" class="email">'+valor.split("|")[1]+'</span><input type="hidden" value="'+valor.split("|")[2]+'|'+valor.split("|")[3]+'|'+valor.split("|")[4]+'" id="codpercli_'+giCount+'"> ',
        '<select  id="emailV_'+giCount+'" title="Email" class="email   inputFormulario ObligatorioECEmail" ></select>'+'<input type="hidden" value="'+valor.split("|")[2]+'|'+valor.split("|")[3]+'|'+valor.split("|")[4]+'" id="codpercli_'+giCount+'"> ',
        '<select  id="tipoCliente_'+giCount+'" title="Tipo Cliente" class="tipoCliente" ></select>',
        '<select  id="telefonoCelularV_'+giCount+'" title="Telefono Celular" class="tipoCliente   inputFormulario ObligatorioECTelefono" ></select>'] );
        BackOfficeCargarNumero(codpercli);
        cargar_selectTelefono("telefonoCelularV_"+giCount,telefonosUsuario);
        cargar_selectTelefono("emailV_"+giCount,correosUsuario);
...
function fnClickAddRowUsuarioAC(valor) {
    ...
    $('#tabla_AC_consultarUsuarioContrato').dataTable().fnAddData( [
        ...
        '<input type="TEXT" id="loginUsuario_'+giCount2+'" title="Usuario" class="loginUsuario obligatorio_AUBO  inputFormulario" maxlength="16" style="width: 220px" >',
        '<select  id="email_'+giCount2+'" title="Email" class="tipoCliente   inputFormulario" ></select><input type="hidden" value="'+valor.split("|")[2]+'|'+valor.split("|")[3]+'|'+valor.split("|")[4]+'" id="codpercli_'+giCount2+'"> ',
        '<select  id="tipoCliente_'+giCount2+'" title="Tipo Cliente" class="tipoCliente obligatorio_AUBO  inputFormulario" onChange="removerGrupos(this.value);" ></select>',
        '<select  id="telefonoCelular_'+giCount2+'" title="Telefono Celular" class="tipoCliente   inputFormulario " ></select>'] );
    BackOfficeCargarNumero(codpercli);
    cargar_select("tipoCliente_"+giCount2,tipoGrupo);
    if (giCount2>0){
...
function fnClickAddRowUsuarioACAdministrator(valor) {
    ...
    $('#tabla_AC_consultarUsuarioContrato').dataTable().fnAddData( [
        ...
        '<span id="nombreUsuario_'+giCount2+'" class="nombreValidar">'+valor.split("|")[0]+'</span>',
        '<input type="TEXT" id="loginUsuario_'+giCount2+'" title="Usuario" class="loginUsuario obligatorio_AUBO  inputFormulario" maxlength="16" style="width: 220px" >',
        '<select  id="email_'+giCount2+'" title="Email" class="tipoCliente   inputFormulario" ><option value="'+valor.split("|")[5]+'">'+valor.split("|")[5]+'</option></select><input type="hidden" value="-2" id="codpercli_'+giCount2+'"> '+'<input type="hidden" value="'+valor+'" id="datosUC_'+giCount2+'"> ',
        '<select  id="tipoCliente_'+giCount2+'" title="Tipo Cliente" class="tipoCliente obligatorio_AUBO  inputFormulario" onChange="removerGrupos(this.value);" ></select>',
        '<select  id="telefonoCelular_'+giCount2+'" title="Telefono Celular" class="tipoCliente   inputFormulario " ><option value="'+valor.split("|")[3]+'">'+valor.split("|")[3]+'</option></select>'] );
...
function fnClickAddRowUsuarioACAdministratorEdit(valor) {
    ...
    $('#tabla_EC_consultarUsuarioContrato').dataTable().fnAddData( [
        '<input type="checkbox" checked="checked" class="usuarioAgregarEC nuevoUsuario" id="guardar_'+giCount+'">',
        '<span id="nombreUsuario_'+giCount+'" class="nombreValidar">'+valor.split("|")[0]+'</span>',
        '<input type="TEXT" id="loginUsuario_'+giCount+'" title="Usuario" class="loginUsuario obligatorio_EUBO  inputFormulario" maxlength="16" style="width: 220px" >',
        '<select  id="emailV_'+giCount+'" title="Email" class="tipoCliente obligatorio_EUBO  inputFormulario ObligatorioECEmail" ><option value="'+valor.split("|")[5]+'">'+valor.split("|")[5]+'</option></select><input type="hidden" value="-2" id="codpercli_'+giCount+'"> '+'<input type="hidden" value="'+valor+'" id="datosUC_'+giCount+'"> ',
        '<select  id="tipoCliente_'+giCount+'" title="Tipo Cliente" class="tipoCliente obligatorio_EUBO  inputFormulario" onChange="removerGrupos(this.value);" ></select>',
        '<select  id="telefonoCelularV_'+giCount+'" title="Telefono Celular" class="tipoCliente   inputFormulario ObligatorioECTelefono" ><option value="'+valor.split("|")[3]+'">'+valor.split("|")[3]+'</option></select>'] );
    BackOfficeCargarNumero("");
    cargar_select("tipoCliente_"+giCount,tipoGrupo);
    if (giCount>0){
        removerGrupos($("#tipoCliente_0").val());
...
{   var sOut = '<table width="100%">';             CONTRATOS
    if(idioma=="_us_en"){
...
function BackOfficeBusquedaUsuariosSuccess(originalRequest){
    ...
    $("#div_carga_usuario_ABC").addClass("oculto");
}
...
function BackOfficeBusquedaCarterasSuccess(originalRequest){
    ...
    $("#div_carga_carteras_ABC").addClass("oculto");
}
...
function BackOfficeCargarEditarContratosSuccess(originalRequest){
    ...
    $.each($("#tabla_EC_consultarUsuarioContrato .usuarioViejo"),function(pos,item){
       ...
       var usuario=Trim($("#loginUsuarioV_"+this.id.split("_")[1]).html());
        ...
        cargar_selectTelefono("emailV_"+this.id.split("_")[1],correosUsuario);
...
//        $('#tabla_AC_consultarCarterasContrato').dataTable().fnAddData( [
//            '<img style="cursor:pointer" src="resources/images/comun/nolines_plus.gif" class="detalleBusquedaCartera" width="9" height="9" id="'+valor.split("|")[4]+'||'+valor.split("|")[5]+"|| "+'" type="button">',
//            '<input type="checkbox" checked="checked" class="carteraAgregarAC nuevaCartera" id="guardarCartera_'+giCountC2+'">',
//            '<span id="codigoCartera_'+giCountC2+'" class="codigoCartera">'+valor.split("|")[0]+'</span>',
//            '<span id="modalidad_'+giCountC2+'" class="modalidad">'+valor.split("|")[1]+'</span>',
//            '<span id="estatus_'+giCountC2+'" class="estatus">'+valor.split("|")[2]+'</span>',
//            '<span id="clientePrincipal_'+giCountC2+'" class="clientePrincipal">'+valor.split("|")[3]+'</span>',
//            '<span id="asesor_'+giCountC2+'" class="asesor">'+valor.split("|")[4]+'</span>',
//            '<span id="ejecutivo_'+giCountC2+'" class="ejecutivo">'+valor.split("|")[5]+'</span>'
//        ] );
