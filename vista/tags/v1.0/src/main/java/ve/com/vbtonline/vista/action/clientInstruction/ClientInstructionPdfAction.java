...
public class ClientInstructionPdfAction extends ActionSupport implements ServletContextAware, SessionAware,Serializable {
    ...
    public String generatePdfClientInstruction() throws Exception {
        ...
        try{
            ...
            numeros = clientInstructionPdfServicio.insertarNumeroControl( carta, sessionid,  user.getCodpercli(), user.getIP());
            ...
            this.GuardarLog(user.getLogin(),"13","1","11",String.valueOf(carta.getMaxcartas()),user.getIP(),carta.getDescTipoTransf());
            ...
            if(numeros.size()>0){
                try{
                 clientInstructionPdfServicio.eliminarNumeroControl(numeros);
                }catch(Exception e1){}
            }
           // e.printStackTrace();
