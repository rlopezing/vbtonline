    ...
    public String consultarUsuarios() throws Exception {
        ...
        try{
            ...
            /// cargar elementos de los selects para la consulta
              ...
              SelectOd grupos2 =getFirmasConjuntasServicio().consultarElementos("0000000007", idioma);
              tipoGrupo=grupos2.getContenido();
              session.put("tipoGrupoFC",tipoGrupo);



              SelectOd  estatus2 =getFirmasConjuntasServicio().consultarElementos("0000000001", idioma);
              tipoEstatus=estatus2.getContenido();
              session.put("tipoEstatusFC",tipoEstatus);



              SelectOd  cirif =getFirmasConjuntasServicio().cargarTipoCiRif();
...
//        VBTUsersOd usuario = new VBTUsersOd();
        ...
        try{
            ...
            usuario= getFirmasConjuntasServicio().consultarUsuario(loginUsuario, tipoGrupo);
            idioma = (String) session.get("idioma");
    ...
    public String editarUsuario() throws Exception {
        ...
        try{
            ...
            respuesta=getFirmasConjuntasServicio().editarUsuario(usu,usuAnt,idioma);
            ...
            if (respuesta.equals("OK")){
                ...
                getFirmasConjuntasServicio().guardarLogFC(usuario2.getLogin(),"4","1","1",usu.getLogin(),usuario2.getIP(),"Se ha editado el usuario: "+ usu.getLogin()+" con exito",usuario2.getNumContrato());
                ...
                getFirmasConjuntasServicio().guardarLogFC(usuario2.getLogin(),"4","1","1",usu.getLogin(),usuario2.getIP(),"El usuario: "+ usu.getLogin()+" no pudo ser modificado",usuario2.getNumContrato());
            }
    ...
    public String agregarUsuario() throws Exception {
        ...
        try{
            ...
            usuario = (VBTUsersOd) session.get("user");
            idioma = (String) session.get("idioma");
            respuesta=getFirmasConjuntasServicio().agregarUsuario(usu,usuario,idioma);
            usu.setNumContrato(usuario.getNumContrato());
            if (respuesta.equals("OK")){
                getFirmasConjuntasServicio().correoClientePrincipal(usu,idioma);
                if(idioma == "_us_en"){
                ...
                codigo="OK";
                getFirmasConjuntasServicio().guardarLogFC(usuario.getLogin(),"12","1","1",usu.getLogin(),usuario.getIP(),"Se ha agrego un usuario: "+ usu.getLogin()+ " de Firmas Conjuntas",usuario.getNumContrato());
    ...
    public String guardarParametrosPersonales() throws Exception {
        ...
        try{
            ...
            idioma = (String) session.get("idioma");
            respuesta=getFirmasConjuntasServicio().guardarParametrosPersonales(parametrosPersonalesFC);
    ...
    public String cargarParametrosPersonales() throws Exception {
        ...
        try{
            ...
            parametrosPersonalesFC=getFirmasConjuntasServicio().cargarParametrosPersonales(parametros);
    ...
    public String cargarParametrosPersonalesBase() throws Exception {
        ...
        try{
            ...
            parametrosPersonalesBaseFC=getFirmasConjuntasServicio().cargarParametrosPersonalesBase();
