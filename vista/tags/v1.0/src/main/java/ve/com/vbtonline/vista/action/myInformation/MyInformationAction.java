...
public class MyInformationAction extends ActionSupport implements ServletContextAware, SessionAware,Serializable {
    ...
    public String cargar() throws Exception {
        ...
        try{
            ...
            myInformation=getMyInformationServicio().cargar("", data.getMyInformations().get(0));
...
//
            ...
            TableOd tabla = getMyInformationServicio().consultarTelefonos(parametros, idioma);
            ...
            parametros = new ArrayList<>();
            parametros.add(usuario.getCodpercli());
            tabla = getMyInformationServicio().consultarDirecciones(parametros, idioma);
            ...
            parametros = new ArrayList<>();
            parametros.add(usuario.getCodpercli());
            tabla = getMyInformationServicio().consultarDocumentos(parametros, idioma);
            ...
            parametros = new ArrayList<>();
            parametros.add(usuario.getCodpercli());
            tabla = getMyInformationServicio().consultarRepresentantes(parametros, idioma);
            ...
            parametros = new ArrayList<>();
            parametros.add(usuario.getCodpercli());
            tabla = getMyInformationServicio().consultarContactos(parametros, idioma);
            ...
            tablaDetalle = getMyInformationServicio().consultarCarteras(parametros, idioma);
...
//            detalleCliente = tablaDetalle.getDetalles();
           ...
           // if(usuario.getTipo().equals("6") || usuario.getTipo().equals("7") || usuario.getTipo().equals("8") || usuario.getTipo().equals("9")){
                ...
                parametros.add(usuario.getTelefono_celular());
