...
//            System.out.println("*****claveEmail:"+clave.toLowerCase());
    ...
    public String crearClaveRamdomOpeEsp() throws Exception {
        ...
        try{
            ...
            clave=getSecurityServicio().crearClaveRamdom2(u);
            String respuesta = getSecurityServicio().cambiarClaveOpeEsp(clave, u.getLogin(), u);
//            String respuesta = "OK";
...
//                mailManager.sendPlainMail(ResourceBundle.getBundle("vbtonline").getString("adminmail"),"rafgoddark@gmail.com".toLowerCase(),ResourceBundle.getBundle("Comun"+idioma).getString("TAGTitEmailPassOpeEsp"),htmlText);
                ...
                //getSecurityServicio().guardarLog(u.getLogin(),"23","1","23", "",u.getIP(),"Se ha enviado un correo a los siguientes destinatarios: " + u.getEmail());
    ...
    public String enviarClave() throws Exception {
        ...
        String result=new String();
        result = SUCCESS;
        VBTUsersOd usuario,u, usuarioSesion;
        String clave = new String();
        ...
        try{
            ...
            clave=getSecurityServicio().crearClaveRamdom2(usuario2);
            respuesta = "NO OK";
            respuesta = getSecurityServicio().salvarNuevoPassword(clave,usuarioCliente, usuario2);
            if(respuesta.equalsIgnoreCase("OK")){
                mailContrato = getSecurityServicio().obtenerEmailContrato(usuarioCliente, usuario2);
                MailManager365 mailManager = new MailManager365("vbtonline");
                ...
                usuarioSesion=(VBTUsersOd)session.get("user");
                getSecurityServicio().guardarLog(usuarioSesion.getLogin(),"23","1","23", "", usuarioSesion.getIP(),"Se ha enviado un correo a los siguientes destinatarios: " + usuarioSesion.getEmail()+" motivado al envio de Clave por Correo");
...
//
    ...
    public String enviarClaveSMS() throws Exception {
        ...
        try{
            ...
            data = gson.fromJson(this.jsonParametros, DataJson.class);
            usuarioCliente = data.getParametros().get(0);
            String IPLocal = data.getParametros().get(1);
            ...
            if(respuesta.equalsIgnoreCase("OK")){
                ...
                carteras= getSecurityServicio().carterasUsuario(usuarioCliente, usuario2);
                String mensaje = ResourceBundle.getBundle("ContratosEditar_us_en").getString("TAGUserSMS")+": "+this.mascaraUsuario(usuarioCliente.toLowerCase())+ResourceBundle.getBundle("ContratosEditar_us_en").getString("TAGPassword") + ": " + clave.toLowerCase();

                String emailsEjecuvitos=getSecurityServicio().emailEjecutivos(carteras.get(2),usuario2);
                String telefono;
                String respuestaMsj="";
                ...
                if (!telefono.equalsIgnoreCase("0")){
                    respuestaMsj=vbt.enviarAlertaONL("9102",mensaje,usuarioCliente.toLowerCase(),ResourceBundle.getBundle("vbtonline").getString("adminSMS"));
                    ...
                    if(session.get("user")==null)
                        getSecurityServicio().guardarLog(usuarioCliente,"23","1","23", "", IPLocal,"Se ha enviado un correo a los siguientes destinatarios: " + emailsEjecuvitos+" motivado al reinicio de contraseña");
                    else{
                        usuarioSesion =   (VBTUsersOd)session.get("user");
                        getSecurityServicio().guardarLog(usuarioSesion.getLogin(),"23","1","23", "", usuarioSesion.getIP(),"Se ha enviado un correo a los siguientes destinatarios: " + emailsEjecuvitos+" motivado al reinicio de contraseña");
                    }
...
//
                ...
                if(session.get("user") == null)
                    getSecurityServicio().guardarLog(usuarioCliente, "14", "1", "1", usuarioCliente, IPLocal, "Reinicio de clave, enviada al telefono: " + telefono);
                else{
                    usuario=(VBTUsersOd)session.get("user");
        ...
        try {
            ...
            if(intentos_clave<3){
                if(data.getParametros().get(0).equalsIgnoreCase(claveGenerada)){
                    ...
                    if(intentos_clave==2){
                        resultado ="Cancel";
                        String bloqueo=getSecurityServicio().bloquearUsuario(usuario.getLogin(), usuario);
            ...
            /**
             * SIEMPRE MANDO OK EN DESARROLLO PARA QUE NO ME PIDA LA VALIDACION
...
//                }
                ...
                VBTUsersOd usuarioSesion=(VBTUsersOd)session.get("user");

                getSecurityServicio().guardarLog(usuarioSesion.getLogin(),"23","1","23", "", usuarioSesion.getIP(),"Se ha enviado un correo a los siguientes destinatarios: " + mailContrato.get(0)+" motivado al envio de usuario por correo");
...
//
    ...
    public String enviarClaveUsuarioFirmaConjunta() throws Exception {
        ...
        try{
            ...
            clave=getSecurityServicio().crearClaveRamdom2(usu);
            respuesta = "NO OK";
            respuesta = getSecurityServicio().salvarNuevoPassword(clave,usuarioCliente, usu);
            if(respuesta.equalsIgnoreCase("OK")){

                String mensaje =ResourceBundle.getBundle("ContratosEditar"+idioma).getString("TAGresetPassword2")+". "+ResourceBundle.getBundle("ContratosEditar"+idioma).getString("TAGUserSMS")+": "+this.mascaraUsuario(usuarioCliente.toLowerCase()) +ResourceBundle.getBundle("ContratosEditar"+idioma).getString("TAGPassword")  + ": " + clave.toLowerCase();
                String telefono;
                String respuestaMsj="";
                telefono= vbt.getTelefonoONL(usuarioCliente,ResourceBundle.getBundle("vbtonline").getString("adminSMS"));
                if (!telefono.equalsIgnoreCase("0")){
                ...
                mailContrato = getSecurityServicio().obtenerEmailContrato(usuarioCliente,usu);
                MailManager365 mailManager = new MailManager365("vbtonline");
                String htmlText = "";
              ...
              /*  if ( !mailContrato.get(1).equals("") ) {
               ...
               htmlText += ResourceBundle.getBundle("UsuariosEditar"+idioma).getString("TAGMsgEmail008") +
                ...
                getSecurityServicio().correoClientePrincipal(usuarioCliente, idioma, htmlText,usuario);
...
//            mailManager.sendPlainMail(ResourceBundle.getBundle("vbtonline").getString("adminmail"),mailContrato.get(0),"VBT Bank & Trust Online",htmlText);
            ...
            telefono= vbt.getTelefonoONL(usuarioCliente,ResourceBundle.getBundle("vbtonline").getString("adminSMS"));
            if (!telefono.equalsIgnoreCase("0")) {
                respuestaMsj=vbt.enviarAlertaONL("9101",mensaje,usuarioCliente.toLowerCase(),ResourceBundle.getBundle("vbtonline").getString("adminSMS"));
                respuesta="OK";
                vbt=null;
            }else {
                respuesta="OK";
...
//
    ...
    public String enviarUsuarioCorreo() throws Exception {
        final String origen = "SecurityAction.enviarUsuarioCorreo";
        long time;
        String result=new String();
        result = SUCCESS;
        String clave = new String();
        ...
        try{
            ...
            usuarioCliente = data.getParametros().get(0);
                ...
                if (!telefono.equalsIgnoreCase("0")) {
                    ...
                    getSecurityServicio().guardarLog(usuarioSesion.getLogin(),"23","1","23", "", usuarioSesion.getIP(),"Se ha enviado un correo a los siguientes destinatarios: " + emailsEjecuvitos+" motivado al envio de usuario por SMS");
...
//            clave=getSecurityServicio().crearClaveRamdom2();
            ...
            if (!claveCrypt.equalsIgnoreCase(u.getPassword())){
                ...
                String respuesta = "";
                respuesta =getSecurityServicio().verificarClaveOpeEsp(u.getLogin(),claveTmp, u);
                if(respuesta.equalsIgnoreCase("OK")){
                    respuesta = getSecurityServicio().cambiarClaveOpeEspPersonal(clave, u.getLogin(),u);
                    if(respuesta.equalsIgnoreCase("OK")){
                        resultado = "OK";
                        MailManager365 mailManager = new MailManager365("vbtonline");
                        SimpleDateFormat formatoFecha = new SimpleDateFormat("dd/MM/yyyy",new Locale("es","ve".toUpperCase()));
    ...
    public String verificarSiClaveProvisonalOpeEsp() throws Exception {
        ...
        try{
            ...
            u=(VBTUsersOd) session.get("user");
            idioma = (String) session.get("idioma");
           cambiar = getSecurityServicio().verificarSiClaveProvisonalOpeEsp(u.getLogin(),u);
    ...
    public String cargarCoordenadas() throws Exception {
        ...
        try{
            ...
            SecurityCardOd tarjeta= getSecurityServicio().cargarCoordenadas(usuario.getLogin(),usuario.getIP(), usuario);
    ...
    public String validarCoordenadas() throws Exception {
        ...
        try{
            ...
            if(intentos_clave<3){
                ...
                respuesta = getSecurityServicio().validarCoordenadas(usuario.getLogin(),usuario.getIP(), data.getParametros().get(1), data.getParametros().get(0), data.getParametros().get(2),data.getParametros().get(4), data.getParametros().get(3), data.getParametros().get(5), usuario);
    ...
    public String cargarMetodos() throws Exception {
        ...
        try{
            ...
            idioma = (String) session.get("idioma");
           System.out.println(getClass() + "ANTES DE LLAMAR AL SERVICIO");
           ServicioVbt vbt=new ServicioVbt();
           String resultado=vbt.getTelefonoONL(usuario.getLogin(),ResourceBundle.getBundle("vbtonline").getString("adminSMS"));
            if (resultado!=null){
                if (resultado.length()>0){
                    numeroTelf=resultado.split("-")[1];
                    codigoPais=resultado.split("-")[0];
                }
            }else{
                resultado="0";
            }
            ...
            if(!resultado.equalsIgnoreCase("0")){
              ...
              telefono="(+"+codigoPais+")*******"+numeroTelf.substring(numeroTelf.length()-4,numeroTelf.length());
            ...
            resultado= getSecurityServicio().cargarTarjeta(usuario.getLogin(), usuario);
    ...
    public String mascaraUsuario (String usuario) throws Exception {
        ...
        try {
            ...
            logger.info(ResourceBundle.getBundle("mensajeslogs").getString("mensaje.inicio.ino")+ SecurityAction.class+" | "+origen);
            ...
            logger.info(ResourceBundle.getBundle("mensajeslogs").getString("mensaje.exitos.ino")+ SecurityAction.class+" | "+origen);
