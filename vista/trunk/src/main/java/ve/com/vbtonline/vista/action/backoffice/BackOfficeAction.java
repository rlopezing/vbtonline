...
//
    ...
    public String crearAviso() throws Exception {
        ...
        try {
            ...
            if (parametros.get(7).equals("add")) {
                ...
                getBackOfficeServicio().guardarLog(usuario.getLogin(), "12", "1", "25", "", usuario.getIP(), "Creación de aviso con exito");
            } else {
                //Editar aviso
                ...
                getBackOfficeServicio().guardarLog(usuario.getLogin(), "4", "1", "25", "", usuario.getIP(), "Edición de aviso con exito");
            }
    ...
    public String editarEstatusCuentaNoPermitida() {
        ...
        try {
            ...
            getBackOfficeServicio().guardarLog(usuario.getLogin(), "4", "1", "27", "", usuario.getIP(), "Edición de cuenta bancaria bloqueada con exito");
