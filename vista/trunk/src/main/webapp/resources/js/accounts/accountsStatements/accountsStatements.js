...
var urlReportEdoCuenta="reportEdoCuentaFondoMutual.action";
...
//    $("#estado_cuenta_fecha_anio").val(anio);
    $("#estado_cuenta_imprimir").fadeOut("fast");
    $("#estado_cuenta_tabla_consulta2").empty();
}
...
function detalleEdoCuentaSuccess(originalRequest){
    ...
    if(codigo=="1"){
        ...
        $("#moneda_AS").html(createCurrency(detalle.moneda));
        ...
        crearTablaV2('estado_cuenta_tabla_consulta2',columnas,datos,"",false);
//
        if(idioma=="_us_en"){
/*            var oTable = $('#estado_cuenta_tabla_consulta2').dataTable({
                "bJQueryUI": true,
