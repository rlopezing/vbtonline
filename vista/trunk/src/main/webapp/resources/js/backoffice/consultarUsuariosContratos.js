...
$(document).ready(function(){
    $.mask.definitions['~']='[ACEGIJPRV]';
    $(".mascaraRif").mask("~-?9999999999999");


    $("#codigoPaisUC").intlTelInput();


    $("#telefonoCelEU_CUC").change(function() {
        $("#codigoPaisUC").intlTelInput("setNumber", "+"+$("#telefonoCelEU_CUC").val().split("|")[0]);
    });
...
//        alert("hizo click : "+);
    ...
    $("#btnResetearPasswordEU_CUC").click(function(){
       if(confirm("Se reiniciar\u00e1 la clave del usuario. La nueva clave sera enviada al numero (+"+usuarioEditarContrato.codigoPais+")"+usuarioEditarContrato.telefono_celular+"\n ¿Desea Continuar?")){
    ...
    $("#btnEnviarUsuarioEU_CUC").click(function(){
       if(confirm("Se enviar\u00e1 el nombre de usuario al cliente, al numero (+"+usuarioEditarContrato.codigoPais+")"+usuarioEditarContrato.telefono_celular+"\n ¿Desea Continuar?")){
           $("#div_carga_espera").removeClass("oculto");
    ...
    $("#btnDeshacerEU_CUC").click(function(){
        ...
        if (usuarioEditarContrato.codpercli==null)
            usuarioEditarContrato.codpercli="";
        if ((usuarioEditarContrato.tipo_grupo=="0000000016")&&(usuarioEditarContrato.codpercli=="")){

            $("#ciRifEU_CUC").val(usuarioEditarContrato.cirif);
            $("#nombreEU_CUC").val(usuarioEditarContrato.nombres);
            $("#direccionEU_CUC").val(usuarioEditarContrato.direccion);
...
//        BackOfficeUsuarioOpcionesSistemaCUCJSONData("2");
        consultarOpcionesEspecialesCUCJSONData();
...
function BackOfficeEditarUsuarioContratoJSONData(id){
    ...
    sendServiceJSON_sinc(url,param,BackOfficeEditarUsuarioContratoSuccess,null,null);
}
...
//        $("#"+this.id).removeAttr("disabled", "disabled" );
    ...
    //Permite editar el usuario administrador de firmas conjuntas
    if (usuarioEditarContrato.codpercli==null)
        usuarioEditarContrato.codpercli="";
    if ((usuarioEditarContrato.tipo_grupo=="0000000016")&&(usuarioEditarContrato.codpercli=="")){
        // $('#emailEU_CUC').replaceWith("<input class='obligatorio_EUCBO cambioStatus' style='width:200px;' type='text' id='emailEU_CUC'>");
        $('#emailEU_CUC').replaceWith("<input class='form-filter__input input input--form obligatorio_EUCBO cambioStatus' type='text' id='emailEU_CUC'>");

        // $('#telefonoEU_CUC').replaceWith("<input class='obligatorio_EUCBO cambioStatus' style='width:200px;' type='text'  title='Telefono' id='telefonoEU_CUC'>");
        $('#telefonoEU_CUC').replaceWith("<input class='form-filter__input input input--form obligatorio_EUCBO cambioStatus' type='text'  title='Telefono' id='telefonoEU_CUC'>");

        // $('#telefonoCelEU_CUC').replaceWith("<input class='obligatorio_EUCBO cambioStatus mascaraCelular' style='width:105px;' type='text' title='Telefono Celular' id='telefonoCelEU_CUC'>");
        $('#telefonoCelEU_CUC').replaceWith("<input class='form-filter__input input input--form obligatorio_EUCBO cambioStatus mascaraCelular' type='text' title='Telefono Celular' id='telefonoCelEU_CUC'>");

        // $('#nombreEU_CUC').replaceWith("<input class='obligatorio_EUCBO cambioStatus' style='width:200px;' type='text' title='Nombre' id='nombreEU_CUC'>");
        $('#nombreEU_CUC').replaceWith("<input class='form-filter__input input input--form obligatorio_EUCBO cambioStatus' type='text' title='Nombre' id='nombreEU_CUC'>");

        // $('#direccionEU_CUC').replaceWith("<input class='obligatorio_EUCBO cambioStatus' style='width:200px;' type='text' title='Direccion' id='direccionEU_CUC'>");
        $('#direccionEU_CUC').replaceWith("<input class='form-filter__input input input--form obligatorio_EUCBO cambioStatus' type='text' title='Direccion' id='direccionEU_CUC'>");

        // $('#ciRifEU_CUC').replaceWith("<input class='obligatorio_EUCBO cambioStatus' style='width:200px;' type='text' title='C.I./R.I.F' id='ciRifEU_CUC'>");
        $('#ciRifEU_CUC').replaceWith("<input class='form-filter__input input input--form obligatorio_EUCBO cambioStatus' type='text' title='C.I./R.I.F' id='ciRifEU_CUC'>");

        $.mask.definitions['~']='[ACEGIJPRV]';
        $("#ciRifEU_CUC").mask("~-?999999999999999");

        $('#codigoPaisUC').attr("disabled",false);

        $("#codigoPaisUC").intlTelInput("setNumber", "+"+telefonos[0].value.split("|")[0]);

        $("#telefonoEU_CUC").val(telefonoLocal[0].value);

        //$("#telefonoCelEU_CUC").val(telefonos[0].value.split("|")[1]);
        $("#telefonoCelEU_CUC").mask("?/99999999999").val(telefonos[0].value.split("|")[1]);

        $("#nombreEU_CUC").val(usuarioEditarContrato.nombres);

        $("#direccionEU_CUC").val(usuarioEditarContrato.direccion);

        $("#ciRifEU_CUC").mask("~-?999999999999999").val(usuarioEditarContrato.cirif);

    }else{


        // $('#emailEU_CUC').replaceWith("<select class='obligatorio_EUCBO cambioStatus' id='emailEU_CUC'></select>");
        $('#emailEU_CUC').replaceWith("<select class='select-section__select select-section__select--form obligatorio_EUCBO cambioStatus' id='emailEU_CUC'></select>");

        // $('#telefonoEU_CUC').replaceWith("<select title='Telefono' class='cambioStatus' id='telefonoEU_CUC'></select>");
        $('#telefonoEU_CUC').replaceWith("<select title='Telefono' class='select-section__select select-section__select--form cambioStatus' id='telefonoEU_CUC'></select>");

        // $('#telefonoCelEU_CUC').replaceWith("<select title='Telefono Celular' class='obligatorio_EUCBO cambioStatus' id='telefonoCelEU_CUC'></select>");
        $('#telefonoCelEU_CUC').replaceWith("<select title='Telefono Celular' class='select-section__select select-section__select--form obligatorio_EUCBO cambioStatus' id='telefonoCelEU_CUC'></select>");

        // $('#nombreEU_CUC').replaceWith("<label class='datos ' id='nombreEU_CUC'></label>");
        $('#nombreEU_CUC').replaceWith("<label class='form-filter__value ' id='nombreEU_CUC'></label>");

        // $('#direccionEU_CUC').replaceWith("<label class='datos ' id='direccionEU_CUC'></label>");
        $('#direccionEU_CUC').replaceWith("<label class='form-filter__value ' id='direccionEU_CUC'></label>");

        // $('#ciRifEU_CUC').replaceWith("<label class='datos ' id='ciRifEU_CUC'></label>");
        $('#ciRifEU_CUC').replaceWith("<label class='form-filter__value ' id='ciRifEU_CUC'></label>");

        $("#codigoPaisUC").intlTelInput("setNumber", "+"+telefonos[0].value.split("|")[0]);

        $('#codigoPaisUC').attr("disabled",true);
...
function BackOfficeSalvarEditarUsuarioContratoJSONData(){
    ...
    if ((usuarioEditarContrato.tipo_grupo=="0000000016")&&(usuarioEditarContrato.codpercli=="")){
        ...
        datosUsuarioUCBO.codigoPais =   $("#codigoPaisUC").intlTelInput("getSelectedCountryData").dialCode;
        datosUsuarioUCBO.direccion = $("#direccionEU_CUC").val();
        datosUsuarioUCBO.nombres = $("#nombreEU_CUC").val();
        datosUsuarioUCBO.cirif = $("#ciRifEU_CUC").val();

    }else{
        datosUsuarioUCBO.telefono_celular =  $("#telefonoCelEU_CUC").val().split("|")[1];
        datosUsuarioUCBO.codigoPais = +$("#telefonoCelEU_CUC").val().split("|")[0];
...
function consultarOpcionesEspecialesCUCJSONData(){
    var url = urlBackOfficeConsultarOpcionesEspeciales;
    var param={};
    var jsonBackOffice=[];

    jsonBackOffice[0] = $("#usuarioEU_CUC").text();
    jsonBackOffice[1] = "C";

    param.jsonBackOffice=JSON.stringify({"parametros":jsonBackOffice});

    sendServiceJSON_sinc(url,param,consultarOpcionesEspecialesCUCSuccess,null,null);
}

function consultarOpcionesEspecialesCUCSuccess(originalRequest) {
    //                   this is the json return data
    var result = originalRequest;
    var columnas = result.contenidoTabla_culumnasTest;
    var datos = result.contenidoTabla_infoTest;
...
function ocultarHijosUC() {
    try {

        $("#div_tabla_UsuarioOpcionesSistema_CUC .elemento").each(function(){
            var hijos="";
            var codPadre="";
            if ($("#"+this.id).hasClass("padre")){
                ...
                if ($("#"+this.id).val() == "") {
                    codPadre=this.id;
                    $("#div_tabla_UsuarioOpcionesSistema_CUC .hijo").each(function(){
