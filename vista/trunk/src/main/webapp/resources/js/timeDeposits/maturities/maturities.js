...
function validarActivarFechas_ColVen(valor){
   // var myDate = new Date();
    if(valor=="FV"){
        ...
        $("#panelControlesMaturities").fadeIn("fast");
        $("#fechaDesdeFiltro_ColVenField").fadeIn("fast");
        $("#fechaHastaFiltro_ColVenField").fadeIn("fast");
   ...
   //     $("#fechaHastaFiltro_ColVen").val((myDate.getDate()) + '/' + (((myDate.getMonth()+1)>10)?(myDate.getMonth()+1):'0'+(myDate.getMonth()+1)) + '/' + myDate.getFullYear());
        ...
        $("#panelControlesMaturities").fadeOut("fast");
        $("#fechaDesdeFiltro_ColVenField").fadeIn("fast");
        $("#fechaHastaFiltro_ColVenField").fadeOut("fast");
        $("#fechaDesdeFiltro_ColVen").val("");
...
function cargarVencimientos(){
    ...
    $("#fechaDesdeFiltro_ColVenField").attr("style","display: none");
    $("#fechaHastaFiltro_ColVenField").attr("style","display: none");
    $("#panelControlesMaturities").hide();
    consultarVencimientosTransJSONData();
}
...
function consultarVencimientosSuccess(originalRequest){
    ...
    if(codigo=="0"){
        ...
        crearTablaV2('vencimientos_ColVen_tabla_consulta',columnas,datos,"",false);
//
//
/*
...
*/
        ...
        oTable = $('#vencimientos_ColVen_tabla_consulta').dataTable({
            "iDisplayLength": 25,
            "bJQueryUI": false,
            "sPaginationType": "full_numbers",
            "bFilter": false,
...
function print_VENCIMIENTOS(){
    ...
    $("#div_vencimientos_colocaciones").printThis({
