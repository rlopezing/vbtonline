...
$(document).ready(function(){
   ...
   /* $( "#fechaHastaFiltro_Transferencias").blur(function(){
    ...
    $('#tabla_consulta_TransferenciasGenerales tbody td .detalleHistoricoTransfers').live('click', function () {
    ...
    $("#consultar_Transferencias").click(function(){
        ...
        if(mensaje!=""){
            $("#tabla_consulta_TransferenciasGenerales").fadeOut("fast");
            $("#mensaje_error").empty();
            ...
            $("#tabla_consulta_TransferenciasGenerales").fadeIn("fast");
...
function cargarPaginaTransferHistory(){
    if ($("#tipo_contrato_app").val()=="FC"){
        $("#TAG_INFO_TRANSFERENCIA_FI").remove();
    }else{
        $("#TAG_INFO_TRANSFERENCIA_FC").remove();
    }
    $("#tabla_consulta_TransferenciasGenerales").empty();
...
function fnFormatDetailsTransferHistory (valor) {
    ...
    if ($("#tipo_contrato_app").val()=="FC"){
        ...
        if(idioma=="_us_en"){
            ...
            sOut +='</tr>';
            sOut +='<tr><td width="15%" ><span id="transferencias_TAGCancelacion" class="label_descp">Cancelation</span><span class="label_descp">:</span></td>';
            sOut +='<td width="70%"><span id="label_transferHistory_cancelacion">'+valor.split("|")[10]+'</span></td>';
            sOut +='</tr>';
...
function printConsultTranfer(){
    ...
    $("#transfer_history_section").printThis({
...
function detalleHistorico(id){
    consultarDetalle_TransferenciasFCJSONData(id.split("_")[1]);
}
...
function consultarTransferenciasGeneralesSuccess(originalRequest){
    ...
    crearTablaTmpV2('tabla_consulta_TransferenciasGenerales',columnas,datos,"");
