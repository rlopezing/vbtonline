...
function crearResumen(contenedor_id,numReferencia){
    ...
    $.each(lista,function(pos,item){
       ...
       td.html(elementos.split("|")[5]);
        ...
        if (elementos.split("|")[17] != "Savings account"){
            tr=$(document.createElement("tr")).appendTo(table);
            td=$(document.createElement("td")).appendTo(tr);
            td.attr("class","titulo_resumen");
            if(idioma=="_us_en")
                td.html("<span id='resumen_detalle_cuenta_B'>Beneficiary Product</span>");
            else
                td.html("<span id='resumen_detalle_cuenta_B'>Producto Destino</span>");
            td=$(document.createElement("td")).appendTo(tr);
            td.attr("class","datos_resumen");
            td.html(elementos.split("|")[17]);
        }else{
            tr=$(document.createElement("tr")).appendTo(table);
            td=$(document.createElement("td")).appendTo(tr);
            td.attr("class","titulo_resumen");
        ...
        if (elementos.split("|")[6] == "0,00"){
            tr=$(document.createElement("tr")).appendTo(table);
            td=$(document.createElement("td")).appendTo(tr);
            td.attr("class","titulo_resumen");
            if(idioma=="_us_en")
                td.html("<span id='resumen_detalle_units'>Units</span>");
            else
                td.html("<span id='resumen_detalle_units'>Unidades</span>");
            td=$(document.createElement("td")).appendTo(tr);
            td.attr("class","datos_resumen");
            td.html(elementos.split("|")[15]);
        }else{
            tr=$(document.createElement("tr")).appendTo(table);
            td=$(document.createElement("td")).appendTo(tr);
            td.attr("class","titulo_resumen");
...
function consultarDetalle_TransferenciasFCSuccess(originalRequest){
    ...
    if(result.detalle_transferencia.length > 0){
        ...
        if (result.detalle_transferencia[26]=="0"){
            $("#detalle_RUnitsAI").html(result.detalle_transferencia[24]);
            $("#montoDetalleOcultar").hide();
            $("#unitDetalleOcultar").show();
        }else{
            $("#detalle_RAmmountAI").html(result.detalle_transferencia[15]);
            $("#montoDetalleOcultar").show();
            $("#unitDetalleOcultar").hide();
       }
        if (result.detalle_transferencia[25]=="S"){
            if(idioma=="_us_en"){
                $("#detalle_RCancelAI").html("Yes");
            }
            else{
                $("#detalle_RCancelAI").html("Si");
            }
        }else{
            $("#detalle_RCancelAI").html("No");
          //  $("#cancleacionHistoricoOcultar").hide();
        }
        ...
        $("#detalle_transferencias_usr_libera2").html(result.detalle_transferencia[22]);
        $("#detalle_transferencias_fecha_libera2").html(result.detalle_transferencia[23]);
        ...
        if(idioma=="_us_en"){
            ...
            }else if(result.detalle_transferencia[17]=="L"){
            $("#detalle_status_TOB").html("In Process");
            }else if(result.detalle_transferencia[17]=="R"){
            $("#detalle_status_TOB").html("Rejected");
            }else if(result.detalle_transferencia[17]=="D"){
            $("#detalle_status_TOB").html("Rejected");
            }else if(result.detalle_transferencia[17]=="N"){
            $("#detalle_status_TOB").html("Rejected");
            }else if(result.detalle_transferencia[17]=="P"){
            $("#detalle_status_TOB").html("Processed");
            }
        }else{
            if(result.detalle_transferencia[17]=="C"){
                ...
                $("#detalle_status_TOB").html("En Proceso");
            }else if(result.detalle_transferencia[17]=="R"){
                $("#detalle_status_TOB").html("Rechazada");
            }else if(result.detalle_transferencia[17]=="D"){
                $("#detalle_status_TOB").html("Rechazada");
            }else if(result.detalle_transferencia[17]=="N"){
                $("#detalle_status_TOB").html("Rechazada");
            }else if(result.detalle_transferencia[17]=="P"){
                $("#detalle_status_TOB").html("Procesada");
            }
        }
        $("#detalle_RReceiverInformation").html(result.detalle_transferencia[16]);


        if ($("#detalle_transferencias_usr_carga2").html()==""){
            $("#detalle_div_record_TOB").addClass("oculto");
            $("#detalle_div_record_TOB1").addClass("oculto");
            $("#detalle_div_record_TOB2").addClass("oculto");
            $("#detalle_div_usr_apro").addClass("oculto");
            $("#detalle_div_usr_apro2").addClass("oculto");

        }else{
            $("#detalle_div_record_TOB").removeClass("oculto");
            $("#detalle_div_record_TOB1").removeClass("oculto");
            $("#detalle_div_record_TOB2").removeClass("oculto");
            $("#detalle_div_usr_apro").removeClass("oculto");
            $("#detalle_div_usr_apro2").removeClass("oculto");
        }


        if ($("#detalle_transferencias_usr_libera2").html()==""){
            $("#detalle_div_usr_lib").addClass("oculto");
            $("#detalle_div_usr_lib2").addClass("oculto");

        }else{
            if ($("#tipo_contrato_app").val()=="FC"){
                $("#detalle_div_usr_lib").removeClass("oculto");
                $("#detalle_div_usr_lib2").removeClass("oculto");
            }else{
                $("#detalle_div_usr_lib").addClass("oculto");
                $("#detalle_div_usr_lib2").addClass("oculto");
            }
        ...
        $("#detalle_transferencia_fc").modal({
            showClose: !1,
