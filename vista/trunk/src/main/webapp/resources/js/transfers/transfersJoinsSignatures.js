...
$(document).ready(function(){
    ...
    $("#FC_tagiTemplate").click(function(){
        $("#tabla_Templates_consulta_transfer").empty();
    ...
    $("#FC_btn_TOB_aceptar").click(function(){
        ...
        if(mensaje==""){
            if(idioma =="_us_en"){
                ...
                if (Trim($("#FC_BankCode").get(0).value) == "ABA" && Trim($("#FC_CountryBank").get(0).value) == "US" ) {
                ...
                if( Trim($("#FC_BankCodeIB2").get(0).value)!= "" ||  Trim($("#FC_NameBankIB").get(0).value)!= "" ||
                    ...
                    if (Trim($("#FC_BankCodeIB").get(0).value) == "ABA" && Trim($("#FC_CountryBankIB").get(0).value) == "US" ) {
...
//               mensaje = mensaje + " Amount & Instructions: The amount exceeds the maximum of USD 50.000,00."+"<br>";
                ...
                if( Trim($("#FC_BankCodeIB2").get(0).value)!= "" ||  Trim($("#FC_NameBankIB").get(0).value)!= "" ||
                    ...
                    if ($("#FC_BankCodeIB").get(0).value == "ABA" && Trim($("#FC_CountryBankIB").get(0).value) == "US" ) {
...
function FC_TransfersValidateSuccess(originalRequest){
    ...
    $("#FC_RAmmountAI").html($("#FC_AmmountAI").get(0).value+" "+moneda);
