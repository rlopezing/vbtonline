...
function cargarDetalleCuentaOtrasInversiones(value){
  if(value!="-2"){
      $("#tabla_consulta_SalTrans_OI").empty();
      $("#paginacion_tabla_consulta_SalTrans_OI").empty();
      detalleSaldoTransOtrasInversionesJSONData();

  }
  else{
      console.log('cargarDetalleCuentaOtrasInversiones');
      $("#numero_cuenta_SalTrans_OI").removeClass("error_campo");

      $("#titular_SalTrans_OI").html("");
      $("#moneda_SalTrans_OI").html(createCurrency());
      $("#unidadesBloqueadas_SalTrans_OI").html("");
      $("#unidadDisponible_SalTrans_OI").html("");
      $("#unidadesTotales_SalTrans_OI").html("");
      $("#VUI_SalTrans_OI").html("");
      $("#montoTransito_SalTrans_OI").html("");
      $("#totalMoneda_SalTrans_OI").html("");
...
function validarActivarFechas_SalTrans_OI(valor){
  //  var myDate = new Date();
   if(valor=="-1"){
       ...
       $("#otrasinversionessaldos_TAGFechaDesde").fadeIn("fast");
       $("#otrasinversionessaldos_TAGFechaHasta").fadeIn("fast");
       $("#fechaDesdeFiltro_SalTrans_OI").fadeIn("fast");
       $("#fechaHastaFiltro_SalTrans_OI").fadeIn("fast");
  ...
  //     $("#fechaHastaFiltro_SalTrans_OI").val((myDate.getDate()) + '/' + (((myDate.getMonth()+1)>10)?(myDate.getMonth()+1):'0'+(myDate.getMonth()+1)) + '/' + myDate.getFullYear());
       ...
       $("#otrasinversionessaldos_TAGFechaDesde").fadeOut("fast");
       $("#otrasinversionessaldos_TAGFechaHasta").fadeOut("fast");
       $("#fechaDesdeFiltro_SalTrans_OI").fadeOut("fast");
       $("#fechaHastaFiltro_SalTrans_OI").fadeOut("fast");
...
function BalancesAndTransactionOtherInvestmentsInfoSuccess(originalRequest){
    ...
    $("#otrasinversionessaldos_TAGFechaDesde").attr("style","display: none");
    $("#otrasinversionessaldos_TAGFechaHasta").attr("style","display: none");
    $("#fechaDesdeFiltro_SalTrans_OI").attr("style","display: none");
    $("#fechaHastaFiltro_SalTrans_OI").attr("style","display: none");
...
function detalleSaldoTransOtrasInversionesSuccess(originalRequest){
    ...
    if(codigo=="0"){
        ...
        $("#moneda_SalTrans_OI").html(createCurrency(detalle[1]));
...
function consultarCuentaSaldoTransOtherInvestmentsSuccess(originalRequest){
    ...
    var id_contenedor='tabla_consulta_SalTrans_OI';
...
function print_SALDOS_FONDOS_OI(){
    ...
    $("#div_OtherInvestments_BT").printThis({
