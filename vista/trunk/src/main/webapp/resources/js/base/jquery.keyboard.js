...
$.keyboard = function(el, options){
	...
	$.keyboard.layouts = {
		...
		'international' : {
			'default': [
				...
				'a s d f g h j k l ; \' {enter}',
				'{shift} z x c v b n m , . / {shift}',
				'{aceptar} {alt} {space} {alt} {cancelar}'
			],
			'shift': [
				'~ ! @ # $ % ^ & * ( ) _ + {bksp}',
				'{tab} Q W E R T Y U I O P { } |',
	...
	$.keyboard.defaultOptions = {
		...
		display : {
			'a'      : '\u2714:Aceptar (Shift-Enter)', // check mark - same action as Aceptar
