	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" class="input input--form" />') :
			  sSearchStr==="" ? '<input type="text" class="input input--form" />' : sSearchStr+' <input type="text" class="input input--form" />';
			
			var nFilter = document.createElement( 'div' );
			nFilter.className = oSettings.oClasses.sFilter;
			nFilter.innerHTML = '<label class="nFilter">'+sSearchStr+'</label>';
		...
		function _fnFeatureHtmlTable ( oSettings )
		{
			...
			{
				nScrollBody.style.minHeight = _fnStringToCss( oSettings.oScroll.sY );
			}
		...
		function _fnScrollDraw ( o )
		{
			...
			{
				nScrollBody.style.minHeight = (nScrollBody.offsetHeight + o.nTHead.offsetHeight)+"px";
			}
			...
			if ( o.oScroll.sY === "" )
			{
				...
				if ( ie67 )
				{
					nScrollBody.style.minHeight = _fnStringToCss( o.nTable.offsetHeight+o.oScroll.iBarWidth );
				}
			}
			
			if ( o.oScroll.sY !== "" && o.oScroll.bCollapse )
			{
				nScrollBody.style.minHeight = _fnStringToCss( o.oScroll.sY );
				
				var iExtra = (o.oScroll.sX !== "" && o.nTable.offsetWidth > nScrollBody.offsetWidth) ?
				 	o.oScroll.iBarWidth : 0;
				if ( o.nTable.offsetHeight < nScrollBody.offsetHeight )
				{
					nScrollBody.style.minHeight = _fnStringToCss( o.nTable.offsetHeight+iExtra );
				}
			}
		...
		this.fnClose = function( nTr )
		{
			...
			for ( var i=0 ; i<oSettings.aoOpenRows.length ; i++ )
			{
				if ( oSettings.aoOpenRows[i].nParent == nTr )
				{
					...
					nTr.style.cssText += 'border-bottom: 0.1rem solid var(--primary-color);';
