...
(function ($) {
    ...
    jQuery.J.DrawCalendar = function (dateIn) {
        ...
        prevMonth = d.getMonth() == 0 ? new Date(d.getFullYear() - 1, 11, 1) : new Date(d.getFullYear(), d.getMonth() - 1, 1);
...
/*        var prevMLink = $("#calendar__prev").click(function () {
            jQuery.J.ChangeMonth(prevMonth);
            return false
        });*/
        ...
        nextMonth = d.getMonth() == 11 ? new Date(d.getFullYear() + 1, 0, 1) : new Date(d.getFullYear(), d.getMonth() + 1, 1);
...
/*        var nextMLink = $("#calendar__next").click(function () {
            jQuery.J.ChangeMonth(nextMonth);
            return false
        });*/
...
/*         jQuery(".MonthNavigation", navRow).append(prevYLink ,prevMLink);
        ...
        jQuery(".MonthNavigation", navRow)*/
        $("#calendar__monthyearshort").html(defaults.locale.months[d.getMonth()] + " " + d.getFullYear());
        ...
        do {
            ...
            for (var i = 0; i < 7; i++) {
                ...
                var dayLink = jQuery('<a>' + _currentDate.getDate() + "</a>");
