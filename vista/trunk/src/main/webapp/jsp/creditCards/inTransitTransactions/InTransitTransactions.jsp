...
<main id="alertaSeguridadTDC"  class="main main--modifier">
    <div id="div_creditCard_ITT" class="section">
        <div class="section__container container">
            ...
            <div class="section__content">
                <div id="btn-notification-modal-cc" class="notice" style="justify-content: right;">
    ...
    <div class="notification-modal" id="notification-modal-cc">
        ...
        <div class="notification-modal__spacebetween notification-modal__spacebetween--modifier">
            ...
            <div>
                <a id="TagBtnCloseCC" class="notification-modal__button button-alternative" href="#close" rel="modal:close">Cerrar</a>
            </div>
        </div>
        </div>
    </div>
...
<script>
    $("#btn-notification-modal-cc").click(function (){

        $("#notification-modal-cc").modal({
            showClose: !1,
