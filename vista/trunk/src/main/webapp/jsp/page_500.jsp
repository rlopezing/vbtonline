...
<html>
<head>
    <title>Our site is temporary down for maintenance,</title>
    ...
    <div id="marco_trabajo" >
        <div id="cuerpo">
            <div style="" id="espacio_divs">
                <img width="530" height="270"  style="margin-bottom: 160px;margin-left: 346px;  margin-top: 86px;" src="../vbtonline/resources/images/comun/500-error-page.jpg" alt="">
            </div>
        </div>
    </div>
    <!-- PIE DE PAGINA -->
