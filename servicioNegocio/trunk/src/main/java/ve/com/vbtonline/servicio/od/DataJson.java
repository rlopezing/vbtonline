...
public class DataJson {
    ...
    private List<ConsultLogSmsOd> consultaSMS;
    ...
    private List<ConsultCtasNoPermitidasOd> parametrosCtasNoPermitidas;
    private List<ConsultaTransaccionesEspecialesOd> parametrosTransaccionesEspeciales;

    public List<ConsultaTransaccionesEspecialesOd> getParametrosTransaccionesEspeciales() {
        return parametrosTransaccionesEspeciales;
    }

    public void setParametrosTransaccionesEspeciales(List<ConsultaTransaccionesEspecialesOd> parametrosTransaccionesEspeciales) {
        this.parametrosTransaccionesEspeciales = parametrosTransaccionesEspeciales;
    }
    ...
    public List<ConsultLogSmsOd> getConsultaSMS() {
        return consultaSMS;
    }

    public void setConsultaSMS(List<ConsultLogSmsOd> consultaSMS) {
        this.consultaSMS = consultaSMS;
    }

    public List<ConsultCtasNoPermitidasOd> getParametrosCtasNoPermitidas() {
        return parametrosCtasNoPermitidas;
    }

    public void setParametrosCtasNoPermitidas(List<ConsultCtasNoPermitidasOd> parametrosCtasNoPermitidas) {
        this.parametrosCtasNoPermitidas = parametrosCtasNoPermitidas;
    }
}