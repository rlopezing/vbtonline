...
public class VBTUsersOd implements Serializable {
    ...
    private String validaSoporteContrato;
    ...
    public String getValidaSoporteContrato() {
        return validaSoporteContrato;
    }

    public void setValidaSoporteContrato(String validaSoporteContrato) {
        this.validaSoporteContrato = validaSoporteContrato;
    }
