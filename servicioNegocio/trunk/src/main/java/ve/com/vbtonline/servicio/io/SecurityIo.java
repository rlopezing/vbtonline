...
//                mailManager.sendPlainMail( ResourceBundle.getBundle("vbtonline").getString("adminmail"),"rafgoddark@gmail.com".toLowerCase(),ResourceBundle.getBundle("Comun"+idioma).getString("TAGTitEmailClaveConfirmacion"),htmlText);
                ...
                loggerIo.GuardarLog(usuario.getLogin(),"23","1","23", "",usuario.getIP(),"Se ha enviado un correo a los siguientes destinatarios: " + usuario.getEmail().toLowerCase()+" motivado al envio de sms al usuario: "+usuario.getLogin() ) ;
    ...
    public String crearClaveRamdomSMS (VBTUsersOd usuario, String idioma) throws Exception {
        ...
        try {
            ...
            try{
                ...
                String mensaje= ResourceBundle.getBundle("ContratosEditar"+idioma).getString("TAGUserSMS")+": "+this.mascaraUsuario(usuario.getLogin().toLowerCase(), usuario)+ResourceBundle.getBundle("Comun"+idioma).getString("TAGLinea1SMSClaveConfirmacion")+": " +  nbuf.toString().toLowerCase()+" "+ResourceBundle.getBundle("Comun"+idioma).getString("TAGLinea2SMSClaveConfirmacion");

                String respuestaMsj=vbt.enviarAlertaONL("9103",mensaje,usuario.getLogin().toLowerCase(),ResourceBundle.getBundle("vbtonline").getString("adminSMS"));
                String numero = vbt.getTelefonoONL(usuario.getLogin().toLowerCase(),ResourceBundle.getBundle("vbtonline").getString("adminSMS")) ;
                if (respuestaMsj.indexOf("ERROR")>-1){
                    // if (respuestaMsj == null){
                    this.GuardarLogFC(usuario.getLogin(), "18", "1", "21", "", usuario.getIP(), "Envio Codigo de confirmacion fallido al numero: " + numero,usuario.getNumContrato());
                }   else{
                    this.GuardarLogFC(usuario.getLogin(), "18", "1", "21","", usuario.getIP(), "Envio Codigo de confirmacion exitoso al numero: " +numero,usuario.getNumContrato());
                }
    ...
    public String correoClientePrincipal (String usuario,String idioma, String text, VBTUsersOd usuarioSesion) throws Exception {
        ...
        try {
            ...
            if(usuarioSesion.getNumContrato()==null)
                statement.setNull(1, OracleTypes.NULL);
            else
                statement.setString(1,usuarioSesion.getNumContrato());
            ...
            if (respuesta.equalsIgnoreCase("OK")){
                ...
                String tipo=ResourceBundle.getBundle("UsuariosAgregar"+idioma).getString("tipo"+usuarioSesion.getTipo());
                String correos="";
                ...
                this.GuardarLogFC(usuarioSesion.getLogin(),"23","1","23", "",usuarioSesion.getIP(),"Se ha enviado un correo a los siguientes destinatarios: " + correos+" motivado al envio de sms al usuario:" +usuario, usuarioSesion.getNumContrato()) ;
...
//                correos= result.getString(1);
    ...
    public String emailEjecutivos (String cartera, VBTUsersOd usuario) throws Exception {
...
//                correos= result.getString(1);
    ...
    public String mascaraUsuario (String usuario, VBTUsersOd usuarioOd) throws Exception {
        final String origen = "SecurityIo.mascaraUsuario";
  ...
  /*
    public String guardarExcepcion (String parametro1, String parametro2,String parametro3,String parametro4,String parametro5,String parametro6) {
        final String origen = "SecurityIo.guardarExcepcion";
        String respuesta="";
        Connection connectionLog = null;
        ResultSet result = null;
        CallableStatement statementLog = null;
