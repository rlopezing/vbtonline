 ...
 */
public class AllMyPortafolioServicio extends BasicService implements IAllMyPortafolioServicio,Serializable {
    ...
    public AllMyPortafolioOd cargar (String transaccionId, AllMyPortafolioOd ampod, VBTUsersOd usuario) throws Exception {
        ...
        try {
            ...
            allMyPortafolioOd = getAllMyPortafolioIo().Cargar("", ampod, usuario);
    ...
    public List<String> cargarCarterasPortafolio (VBTUsersOd usuario) throws Exception {
        ...
        try {
            ...
            carteras = getAllMyPortafolioIo().cargarCarterasPortafolio(usuario);
    ...
    public TableOd cargarTablas (String cartera, String accion, String login, String idioma, VBTUsersOd usuario) throws Exception {
        ...
        try {
            ...
            tabla = getAllMyPortafolioIo().cargarTablas(cartera,accion,login, idioma, usuario);
