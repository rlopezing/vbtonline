...
//              statement.execute ();
    ...
    public String cargarSaldoFacturado (String p_num_cta, String p_codproserv, VBTUsersOd usuario) throws Exception {
    ...
    public String cargarSaldoNoFacturado (String p_num_cta, VBTUsersOd usuario) throws Exception {
...
//                    link=  "<a style='cursor:pointer' onclick='seleccionarVerOtrasInvOpcion(this.id)' title='"+ResourceBundle.getBundle("PortafolioConsolidado"+idioma).getString("TAGTitleVerDetallesFondo")+"' id='"+NullFormatter.formatHtmlBlank(result.getString(4)) + " | " + cartera+"' >"+NullFormatter.formatHtmlBlank(result.getString(1)+"</a>");
                    ...
                    saldoFacturado2 = cargarSaldoFacturado(result.getString(3), "002", usuario);

                    if (!NullFormatter.isBlank(saldoFacturado2))
                        saldoFacturado = Double.parseDouble(saldoFacturado2);

                    saldoNoFacturado2 = cargarSaldoNoFacturado(result.getString(3), usuario);
...
//
    ...
    public String GuardarLog (String parametro1, String parametro2,String parametro3,String parametro4,String parametro5,String parametro6, String parametro7) throws Exception {
        final String origen = "AllMyPortafolioIo.GuardarLog";
        String respuesta="";
    ...
    public String guardarExcepcion (String parametro1, String parametro2,String parametro3,String parametro4,String parametro5,String parametro6) {
        final String origen = "AllMyPortafolioIo.guardarExcepcion";
        String respuesta="";
        Connection connectionLog = null;
        ResultSet result = null;
        CallableStatement statementLog = null;
