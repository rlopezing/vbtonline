...
public class ReportsPdfIo extends comundao implements Serializable {
    ...
    public List<String> consultarCabeceraEdoCuenta (String num_cta, String mes , String anio, VBTUsersOd usuario) throws Exception {
        ...
        try {
            ...
            statement  = connection.prepareCall ("begin UTIL_PDF.vbt_PDFCuentasEdoCuenta_Enc_pr(?,?,?,?,?); end;");
////
            ...
            while (result.next()){
                ...
                cabecera.add(result.getString(15).trim());
    ...
    public List<String> consultarCabeceraEdoCuentaTDC (String num_cta, String codproserv , String mes, VBTUsersOd usuario) throws Exception {
        ...
        try {
            ...
            statement  = connection.prepareCall ("begin UTIL_PDF.vbt_PDFTDCEdoCta_Enc_pr(?,?,?,?,?); end;");
////
            statement.setString(1, num_cta);
...
//
    ...
    public List<List<String>> consultarTablaEdoCuenta (String num_cta, String mes , String anio, VBTUsersOd usuario) throws Exception {
        ...
        try {
            ...
            statement  = connection.prepareCall ("begin UTIL_PDF.vbt_PDFCuentasEdoCuenta_Det_pr(?,?,?,?,?); end;");
...
//                    DET.MTOMOV
    ...
    public List<List<String>> consultarTablaEdoCuentaTDC (String num_cta, String codproserv , String mes, VBTUsersOd usuario) throws Exception {
        ...
        try {
            ...
            statement  = connection.prepareCall ("begin UTIL_PDF.vbt_PDFTDCEdoCta_Det_pr(?,?,?,?,?); end;");
//            vbt_PDFCuentasEdoCuenta_Det_pr (p_strNumeroCuenta    		IN VARCHAR2,
//                    p_strCmbMes				IN VARCHAR2,
//                    p_strTxtA񯉉		IN VARCHAR2,
//                    p_vbt_PDFCtasEdoCtaDet 	OUT vbt_PDFCtasEdoCtaDet,
...
//
    ...
    public List<String> consultarDatosCliente (String cliente, VBTUsersOd usuario) throws Exception {
        ...
        try {
            ...
            statement  = connection.prepareCall ("begin UTIL_PDF.vbt_PDFColOperacionDetalle_pr(?,?,?); end;");
...
//                    DECODE(NVL(TD.fechaper,''),'','',TRIM(TO_CHAR(TD.fechaper, 'Month','nls_date_language=english')) || ', ' || TO_CHAR(TD.fechaper, 'dd yyyy','nls_date_language=english')) fecha_apertura
    ...
    public List<List<List<String>>> consultarTablaEdoCuentaFondos (String codemp, String codcar , String fechaEmision, String razon, String moneda, VBTUsersOd usuario) throws Exception {
        final String origen = "ReportsPdfIo.consultarTablaEdoCuentaFondos";
        Connection connection = null;
        CallableStatement statement = null;
        ResultSet result = null;
        long fila = 0, time = 0, time2 = 0, time3 = 0;
...
//
            ...
            while (result.next()){
                ...
                datos.add(NullFormatter.formatHtmlBlank(result.getString(5)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(6)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(7)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(8)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(9)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(10)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(11)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(12)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(13)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(14)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(15)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(16)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(17)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(18)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(19)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(20)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(21)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(22)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(23)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(24)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(25)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(26)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(27)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(28)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(29)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(30)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(31)));
                datos.add(NullFormatter.formatHtmlBlank(result.getString(32)));


                if (NullFormatter.formatHtmlBlank(result.getString(1)).equalsIgnoreCase("1")){
                    tablaEncabezado.add(datos);
                }else{
                    tabla.add(datos);
                }

            }
            global.add(tablaEncabezado);
            global.add(tabla);
    ...
    public List<List<String>> consultarTablaEdoCuentaFondosDividendos (String codemp, String fechaEmision, VBTUsersOd usuario) throws Exception {
        final String origen = "ReportsPdfIo.consultarTablaEdoCuentaFondosDividendos";
        Connection connection = null;
        CallableStatement statement = null;
        ResultSet result = null;
        long fila = 0, time = 0, time2 = 0, time3 = 0;
...
//
   ...
   /*
    ...
    public String guardarExcepcion (String parametro1, String parametro2,String parametro3,String parametro4,String parametro5,String parametro6) {
        final String origen = "ReportsPdfIo.guardarExcepcion";
        String respuesta="";
        Connection connectionLog = null;
        ResultSet result = null;
        CallableStatement statementLog = null;
