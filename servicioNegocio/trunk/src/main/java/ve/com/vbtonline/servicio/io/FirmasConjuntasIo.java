    ...
    public String correoClientePrincipal (VBTUsersOd usuario,VBTUsersOd usuarioCreador,String idioma) throws Exception {
        ...
        try {
            ...
            if (respuesta.equalsIgnoreCase("OK")){
                ...
                this.GuardarLogFC(usuarioCreador.getLogin(),"23","1","23", "",usuarioCreador.getIP(),"Se ha enviado un correo a los siguientes destinatarios: " + correos+" motivado a la creación del usuario: "+usuario.getLogin() ,usuarioCreador.getNumContrato()) ;
...
//                           rolesCampos=rolesCampos+","+ResourceBundle.getBundle("vbtonline"+idioma).getString("TAGROL"+usuarioAnterior.getRolesCustom().get(i).getCodigoRol());
                ...
                if (!campos.equalsIgnoreCase("")){
                    ...
                    this.GuardarLogFC(usuarioSesion.getLogin(),"23","1","23", "",usuarioSesion.getIP(),"Se ha enviado un correo a los siguientes destinatarios: " + correos+" motivado a la modificación del usuario: "+usuario.getLogin() ,usuario.getNumContrato()) ;
                }
