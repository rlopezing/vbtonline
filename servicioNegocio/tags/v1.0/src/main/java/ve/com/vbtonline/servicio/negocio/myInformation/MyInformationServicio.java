 ...
 */
public class MyInformationServicio implements IMyInformationServicio,Serializable {
    ...
    public MyInformationOd cargar (String transaccionId, MyInformationOd miod) throws Exception {
        ...
        try {
            ...
            myInformationOd = getMyInformationIo().Cargar("",miod);
    ...
    public TableOd consultarTelefonos (List<String> parametros, String idioma) throws Exception {
        ...
        try {
            ...
            info = getMyInformationIo().consultarTelefonos(parametros, idioma);
    ...
    public TableOd consultarDirecciones (List<String> parametros, String idioma) throws Exception {
        ...
        try {
            ...
            info = getMyInformationIo().consultarDirecciones(parametros, idioma);
    ...
    public TableOd consultarDocumentos (List<String> parametros, String idioma) throws Exception {
        ...
        try {
            ...
            info = getMyInformationIo().consultarDocumentos(parametros, idioma);
    ...
    public TableOd consultarRepresentantes (List<String> parametros, String idioma) throws Exception {
        ...
        try {
            ...
            info = getMyInformationIo().consultarRepresentantes(parametros, idioma);
    ...
    public TableOd consultarContactos (List<String> parametros, String idioma) throws Exception {
        ...
        try {
            ...
            info = getMyInformationIo().consultarContactos(parametros, idioma);
...
//        TableOd info = null;
        ...
        try {
            ...
            info = getMyInformationIo().consultarCarteras(parametros, idioma);
